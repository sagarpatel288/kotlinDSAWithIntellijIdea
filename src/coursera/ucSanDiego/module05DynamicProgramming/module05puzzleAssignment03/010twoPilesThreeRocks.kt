package coursera.ucSanDiego.module05DynamicProgramming.module05puzzleAssignment03

/**
 *  ----------------------- Problem Statement -----------------------
 *
 *  There are two piles of ten rocks. In each turn, you may take up to three
 *  rocks. The player that takes the last rock wins the game. Your opponent
 *  moves first.
 *
